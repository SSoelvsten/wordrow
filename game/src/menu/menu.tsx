...
import { Language, languages } from '../localize/language';
...
const Menu = ({
  ...
  switch (language) {
    case Language.DK:
      start_text = (
        <>
          <b> Klik her </b> eller <b> tryk enter </b> for at starte.
        </>
      );
    ...
    case Language.DE:
      start_text = (
        <>
          <b> Klicken sie hier </b> oder <b> drücken sie die Eingabeteste, </b>{' '}
          um zu beginnen.
        </>
      );
    ...
    case Language.EN:
      start_text = (
        <>
          <b> Click here </b> or <b> press enter </b> to start.
        </>
      );
    ...
    <div className="Menu" tabIndex={0} onKeyDown={onKey} ref={divRef}>
      ...
      <div className="GameTypeSelection">
        {Difficulties.map((d, i) => (
          <NamedSelect
            text={difficultyName(d, language)}
